...
from ..gate_bases import QuantumGate, QuantumGateMultiQubit
...
class Identity_Gate(QuantumGate):
    ...
    def __init__(self,name: str='I', qubits_t: list[int]=[0], qubits_c: None|list[int]=None, step: int=0):
        super().__init__(name=name, name_short='I', shape=(2,2), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=1)
...
class Pauli_X_Gate(QuantumGate):
    ...
    def __init__(self, name: str='X', qubits_t: list[int]=[0], qubits_c: None|list[int]=None, step: int=0):
        super().__init__(name=name, name_short='X', shape=(2,2), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=1)
...
class Pauli_Y_Gate(QuantumGate):
    ...
    def __init__(self, name: str='Y', qubits_t: list[int]=[0], qubits_c: None|list[int]=None, step: int=0):
        super().__init__(name=name, name_short='Y', shape=(2,2), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=1)
...
class Pauli_Z_Gate(QuantumGate):
    ...
    def __init__(self, name: str='Z', qubits_t: list[int]=[0], qubits_c: None|list[int]=None, step: int=0):
        super().__init__(name=name, name_short='Z', shape=(2,2), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=1)
        self.matrix_numeric = np.array([[1, 0], [0, -1]])
...
class Hadamard_Gate(QuantumGate):
    ...
    def __init__(self, name: str='H', qubits_t: list[int]=[0], qubits_c: None|list[int]=None, step: int=0):
        super().__init__(name=name, name_short='H', shape=(2,2), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=1)
...
class Hadamard_error_I_Gate(QuantumGate):
    ...
    def __init__(self, name: str='H_eI', qubits_t: list[int]=[0], qubits_c: None|list[int]=None, step: int=0):
        super().__init__(name=name, name_short='H_eI', shape=(2,2), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=1)
        self.matrix_numeric = np.array([[1, 1], [1, -1]])/np.sqrt(2)
...
class S_Gate(QuantumGate):
    ...
    def __init__(self, name: str='S', qubits_t: list[int]=[0], qubits_c: None|list[int]=None, step: int=0):
        super().__init__(name=name, name_short='S', shape=(2,2), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=1)
...
class Sdg_Gate(QuantumGate):
    ...
    def __init__(self, name: str='Sdg', qubits_t: list[int]=[0], qubits_c: None|list[int]=None, step: int=0):
        super().__init__(name=name, name_short='Sdg', shape=(2,2), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=1)
        self.matrix_numeric = np.array([[1, 0], [0, -1j]])
...
class T_Gate(QuantumGate):
    ...
    def __init__(self, name: str='T', qubits_t: list[int]=[0], qubits_c: None|list[int]=None, step: int=0):
        super().__init__(name=name, name_short='T', shape=(2,2), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=1)
...
class Tdg_Gate(QuantumGate):
    ...
    def __init__(self, name: str='Tdg', qubits_t: list[int]=[0], qubits_c: None|list[int]=None, step: int=0):
        super().__init__(name=name, name_short='Tdg', shape=(2,2), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=1)
        self.matrix_numeric = np.array([[1, 0], [0, np.exp(-1j*np.pi/4)]])
...
class SX_Gate(QuantumGate):
    ...
    def __init__(self, name: str='SX', qubits_t: list[int]=[0], qubits_c: None|list[int]=None, step: int=0):
        super().__init__(name=name, name_short='SX', shape=(2,2), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=1)
        self.matrix_numeric = 1/2*np.array([[1+1j, 1-1j], [1-1j, 1+1j]])

        self.matrix22_t[qubits_t[0]][0] = self.matrix
        self.matrix22_t_numeric[qubits_t[0]][0] = self.matrix_numeric

class U_Gate(QuantumGate):
    ...
    def __init__(self, name: str='U', qubits_t: list[int]=[0], qubits_c: None|list[int]=None, step: int=0, parameters: dict=None):
        ...
        super().__init__(name=name, name_short='U', shape=(2,2), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=1)
...
class GP_Gate(QuantumGate):
    ...
    def __init__(self, name: str='GP', qubits_t: list[int]=[0], qubits_c: None|list[int]=None, step: int=0, parameters: dict=None):
        ...
        super().__init__(name=name, name_short='GP', shape=(2,2), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=1)
...
class RX_Gate(QuantumGate):
    '''Class of the RX(theta) gate. It is a subclass of QuantumGate. 
    ...
    def __init__(self, name: str='RX', qubits_t: list[int]=[0], qubits_c: None|list[int]=None, step: int=0, parameters: dict=None):
        super().__init__(name=name, name_short='RX', shape=(2,2), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=1)
...
class RY_Gate(QuantumGate):
    '''Class of the RY(theta) gate. It is a subclass of QuantumGate. 
    Parameter must be a dict: {'theta': val}, for compatibility with gates of more parameters.  
    '''
    is_should_be_listed_in_gate_collection = True
    ...
    def __init__(self, name: str='RY', qubits_t: list[int]=[0], qubits_c: None|list[int]=None, step: int=0, parameters: dict=None):
        super().__init__(name=name, name_short='RY', shape=(2,2), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=1)
        self.parameters = {'theta': parameters['theta']} if parameters is not None else {'theta': None}
        self.atomics_alt = {key: sp.symbols(key+'_' + self.atomics['00'].name[:-4]) for key in self.parameters.keys()} # {'theta': 'theta_U_qt0_qc0_s0_p00', ...}
...
class RZ_Gate(QuantumGate):
    '''Class of the RZ(lambda) gate. It is a subclass of QuantumGate. 
    ...
    def __init__(self, name: str='RZ', qubits_t: list[int]=[0], qubits_c: None|list[int]=None, step: int=0, parameters: dict=None):
        ...
        super().__init__(name=name, name_short='RZ', shape=(2,2), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=1)
...
class P_Gate(QuantumGate):
    ...
    def __init__(self, name: str='P', qubits_t: list[int]=[0], qubits_c: None|list[int]=None, step: int=0, parameters: dict=None):
        super().__init__(name=name, name_short='P', shape=(2,2), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=1)
...
class CCX_Gate(QuantumGateMultiQubit):
    ...
    def __init__(self, qubits_t: tuple|list[int]=[0], qubits_c: tuple|list[int]=None, step: int=0):
        ...
        super().__init__(name='CCX', name_short='CCX', shape=(8,8), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=4,
...
class CCXX_Gate(QuantumGateMultiQubit):
    ...
    def __init__(self, qubits_t: tuple|list[int]=[0], qubits_c: tuple|list[int]=None, step: int=0):
        ...
        assert qubits_t[0] not in qubits_c, 'Control and target qubits must be different.'
        super().__init__(name='CCXX', name_short='CCXX', shape=(16,16), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=4,
                         gates_t={qubits_t[0]: ('I','I','I','X'), qubits_t[1]: ('I','I','I','X')}, 
                         control_values_c={qubits_c[0]:(0,0,1,1), qubits_c[1]:(0,1,0,1)})

class U_for_CU_Gate(QuantumGate):
    ...
    def __init__(self, name: str='U', qubits_t: list[int]=[0], qubits_c: None|list[int]=None, step: int=0, parameters: dict=None):
        ...
        super().__init__(name=name, name_short='U',shape=(2,2), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=1, parameters=parameters)
...
class CU_Gate(QuantumGateMultiQubit):
    ...
    def __init__(self, qubits_t: tuple|list[int]=[0], qubits_c: tuple|list[int]=None, step: int=0, parameters: dict=None):
        ...
        super().__init__(name='CU', name_short='CU', shape=(4,4), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=2,
...
class CUU_Gate(QuantumGateMultiQubit):
    ...
    num_qubits_c = 1
    is_parametric = True
    parameters = (('theta', 'phi', 'lambda'),('theta', 'phi', 'lambda'))
    def __init__(self, qubits_t: tuple|list[int]=[0], qubits_c: tuple|list[int]=None, step: int=0, parameters: dict=None):
        ...
        super().__init__(name='CUU', name_short='CUU', shape=(8,8), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=2,
...
class CY_Gate(QuantumGateMultiQubit):
    ...
    def __init__(self, qubits_t: tuple|list[int]=[0], qubits_c: tuple|list[int]=None, step: int=0):
        ...
        assert qubits_t[0] != qubits_c[0], 'Control and target qubit must be different.'
        super().__init__(name='CY', name_short='CY', shape=(4,4), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=2,
...
class CZ_Gate(QuantumGateMultiQubit):
    ...
    def __init__(self, qubits_t: tuple|list[int]=[0], qubits_c: tuple|list[int]=None, step: int=0):
        ...
        assert qubits_t[0] != qubits_c[0], 'Control and target qubit must be different.'
        super().__init__(name='CZ', name_short='CZ', shape=(4,4), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=2,
...
class CP_Gate(QuantumGateMultiQubit):
    ...
    def __init__(self, qubits_t: tuple|list[int]=[0], qubits_c: tuple|list[int]=None, step: int=0, parameters: dict=None):
        ...
        super().__init__(name='CP', name_short='CP', shape=(4,4), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=2,
...
class CRX_Gate(QuantumGateMultiQubit):
    ...
    def __init__(self, qubits_t: tuple|list[int]=[0], qubits_c: tuple|list[int]=None, step: int=0, parameters: dict=None):
        ...
        super().__init__(name='CRX', name_short='CRX', shape=(4,4), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=2,
...
class CRY_Gate(QuantumGateMultiQubit):
    ...
    def __init__(self, qubits_t: tuple|list[int]=[0], qubits_c: tuple|list[int]=None, step: int=0, parameters: dict=None):
        ...
        super().__init__(name='CRY', name_short='CRY', shape=(4,4), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=2,
...
class CRZ_Gate(QuantumGateMultiQubit):
    ...
    def __init__(self, qubits_t: tuple|list[int]=[0], qubits_c: tuple|list[int]=None, step: int=0, parameters: dict=None):
        ...
        super().__init__(name='CRZ', name_short='CRZ', shape=(4,4), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=2,
...
class CH_Gate(QuantumGateMultiQubit):
    ...
    def __init__(self, qubits_t: tuple|list[int]=[0], qubits_c: tuple|list[int]=None, step: int=0):
        ...
        assert qubits_t[0] != qubits_c[0], 'Control and target qubit must be different.'
        super().__init__(name='CH', name_short='CH', shape=(4,4), qubits_t=qubits_t, qubits_c=qubits_c, step=step, num_summands_decomposed=2,
...
class SWAP_Gate(QuantumGateMultiQubit):
    ...
    def __init__(self, qubits_t: tuple|list[int]=[0], qubits_c: tuple|list[int]=None, step: int=0):
        ...
        super().__init__(name='SWAP', name_short='SWAP', shape=(4,4), qubits_t=qubits_t, qubits_c=None, step=step, num_summands_decomposed=4,
