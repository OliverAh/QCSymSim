...
QSymJl.Circuits.add_gate(qc, QSymJl.Gates.U_Gate; qubits_t=[q_reg_1[1]], step=3, is_treat_numeric_only=false, is_treat_alt_only=true)

unitary = QSymJl.Circuits.assemble_symbolic_unitary(qc, true, false)
